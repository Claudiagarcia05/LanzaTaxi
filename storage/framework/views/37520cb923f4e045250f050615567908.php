    ...
    <nav class="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16 md:h-20">
                ...
                <!-- Logo -->
                <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-[#0068CC] focus:ring-offset-2 rounded-lg" aria-label="LanzaTaxi inicio">
...
</html><?php /**PATH /var/www/html/LanzaTaxi/resources/views/index.blade.php ENDPATH**/ ?>