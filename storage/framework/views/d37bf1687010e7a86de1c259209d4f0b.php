    ...
    <nav class="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm nav-animate">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16 md:h-20">
                ...
                <!-- Logo -->
                <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-[#244194] focus:ring-offset-2 rounded-lg" aria-label="LanzaTaxi inicio">
                    <img src="<?php echo e(asset('img/logo_sin_fondo.png')); ?>" alt="LanzaTaxi" class="w-8 h-8 md:w-10 md:h-10 object-contain">
...
</html><?php /**PATH C:\xampp\htdocs\LanzaTaxi\resources\views/index.blade.php ENDPATH**/ ?>